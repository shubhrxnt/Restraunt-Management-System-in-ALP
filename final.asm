...
.STACK 1000H
.DATA
C1 DB 10,13,10,13,'                 YOUR FOOD WILL BE DELIVERED FOLLOWING THE COVID GUIDELINES$',10,13
C2 DB 10,13,10,13,'                                         GET WELL SOON                     $',10,13
C3 DB 10,13,10,13,'                  You will be presented with flowers along with food,$',10,13
C31 DB 10,13,10,13,'                 kindly accept and follow the protocols$',10,13
C4 DB 10,13,10,13,'                  Hope to see you in the restraunt soon      $',10,13
C5 DB 10,13,10,13,'                  TAKE CARE - SHUBHRANT            $',10,13 

N1 DB 10,13,10,13,'                  Great to hear that you are healthy.                      $',10,13
N2 DB 10,13,10,13,'                  See you in the restraunt soon.                           $',10,13
N3 DB 10,13,10,13,'                  ENJOY YOUR MEAL - SHUBHRANT, SHREEYAM, SAMPATH, SHARATH, VIGNESH            $',10,13 

Q1 DB 10,13,10,13,'                 Are you a covid patient (y/n) $',10,13

M1 DB 10,13,10,13,'                 ****Welcome to Our Restaurants****$',10,13 

W2 DB 10,13,10,13,'                 MICROPROCESSORS AND INTERFACING -  J-COMPONENT   $',10,13
W3 DB 10,13,10,13,'                      VELLORE INSTITUTE OF TECHNOLOGY          $',10,13
W4 DB 10,13,10,13,'                 Presented to - MR. VIKAS VIJAYVARGIYA   $',10,13
